...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log('Received auth email hook:', payload.email_data.email_action_type);

    // Create Supabase client with service role to read system settings
              ...
              <tr>
                <td align="center">
                  <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                      <td style="padding: 40px;">
                        <h2 style="margin: 0 0 20px 0; color: #1a1a1a; font-size: 24px;">Bem-vindo!</h2>
                        <p style="margin: 0 0 20px 0; color: #666; font-size: 16px; line-height: 1.6;">
